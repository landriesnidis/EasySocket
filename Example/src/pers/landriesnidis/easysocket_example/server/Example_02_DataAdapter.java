...
public class Example_02_DataAdapter {
...
class EasyServerSocketThread extends BaseServerSocketThread{
	...
	public EasyServerSocketThread(Socket socket) {
		...
		this.addDataAdapter(new StringDataAapter("<String1>","</String1>"));
		this.addDataAdapter(new StringDataAapter("<String2>","</String2>"));
		this.addDataAdapter(new FileDataAapter("."));
	}
